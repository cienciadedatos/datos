...
<title>Datos de Gapminder — paises • datos</title>
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Datos de Gapminder</h1>
    
    <div class="hidden name"><code>paises.rd</code></div>
    </div>
    ...
    <pre class="usage"><span class='no'>paises</span></pre>
        
    <h2 class="hasAnchor" id="format"><a class="anchor" href="#format"></a>Format</h2>

    <p>El cuadro de datos principal tiene 1704 filas y 6 columnas</p><dl class='dl-horizontal'>
<dt>pais</dt><dd><p>países incluídos (factor con 142 niveles)</p></dd>
...
<dt>pib_per_capita</dt><dd><p>PIB per cápita (en dólares americanos, ajustados según inflación)</p></dd>
</dl>
    
    <h2 class="hasAnchor" id="source"><a class="anchor" href="#source"></a>Source</h2>

    <p>http://www.gapminder.org/data/</p>

...
<title>Datos de clima — clima • datos</title>
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>clima.rd</code></div>
    </div>
    ...
    <pre class="usage"><span class='no'>clima</span></pre>
        
    <h2 class="hasAnchor" id="format"><a class="anchor" href="#format"></a>Format</h2>

    <p>Un data.frame con 3,322 líneas y 9 variables</p><dl class='dl-horizontal'>
<dt>origen</dt><dd><p>Estación de clima</p></dd>
...
<dt>punto_rocio</dt><dd><p>temperatura medida en grados Fahrenheit a la cual, dada la presión atmosférica y humedad, condensa el vapor de agua</p></dd>
...
<dt>presion</dt><dd><p>presión atmosférica al nivel del mar medida en milibares</p></dd>

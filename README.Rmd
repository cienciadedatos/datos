...
1. Provee una manera de facilitar las traducciones de conjuntos de datos mediante el uso de un archivo YAML. Esto permite evitar codigo repetitivo, y abre las puertas a más usuarios a proveer traducciones de los nombres de las variables y sus valores.  Este método va a permitir traducir los mismos conjuntos de datos en otros idiomas además.

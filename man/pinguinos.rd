...
\name{pinguinos}
\alias{pinguinos}
\title{Medidas de tamaño de pingüinos adultos en busca de comida cerca de la estación Palmer en la Antártica.}
...
\item{ancho_pico_mm}{un número que indica el ancho del pico (milímetros)}
...
\usage{pinguinos}
\description{Incluye medidas para especie de pingüino, isla dentro del Archipiélago de Palmer, tamaño (largo de aleta, masa corporal, dimensiones de pico) y sexo.}

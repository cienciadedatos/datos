...
\name{jardineros}
\alias{jardineros}
\title{Tabla de estadísticas de jardineros}
\format{Un data frame con 140.921 filas y 18 columnas
\describe{
...
\item{doble_matanzas}{Doble matanzas en las que el jugador ha estado envuelto defensivamente}
\item{bolas_pasadas}{Bolas dejadas pasar (aplicable a los receptores)}

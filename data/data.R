...
delayedAssign('premios_capitanes',
        eval(parse(file.path(system.file('scripts','premios_capitanes.txt', package = 'datos')))))
...
delayedAssign('capitanes',
        eval(parse(file.path(system.file('scripts','capitanes.txt', package = 'datos')))))
